...
<Styles>
 ...
 <Worksheet ss:Name="EPOReport.xls">
...
<xsl:for-each select='//Row[1]/*'>
	...
	<Row ss:AutoFitHeight="0">
    		<Cell ss:Index="4" ss:MergeAcross="4" ss:StyleID="s76" ss:id="crreview"><Data ss:Type="String">Emergency Process Order Report</Data></Cell>
   	</Row>
