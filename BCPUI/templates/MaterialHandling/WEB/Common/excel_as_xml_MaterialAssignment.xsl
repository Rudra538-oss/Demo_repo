...
<Styles>
 ...
 <Worksheet ss:Name="Material Assignment">
...
<xsl:for-each select='//Row[1]/*'>
	...
	<Row ss:AutoFitHeight="0">
    		<Cell ss:Index="4" ss:MergeAcross="2" ss:StyleID="s76" ss:id="Stoppages"><Data ss:Type="String">Material Assignment</Data></Cell>
   	</Row>
<Row>
